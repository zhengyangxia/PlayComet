...
Revolve::Revolve(){
    attr_map.insert(std::pair<std::string, PlanetRevolveAttributes>("Jupiter", {200.f, 2000.f, glm::vec3(0.f, 1.f, 1.f)}));
    attr_map.insert(std::pair<std::string, PlanetRevolveAttributes>("Earth", {175.f, 3000.f, glm::vec3(0.f, 1.f, 0.f)}));
    attr_map.insert(std::pair<std::string, PlanetRevolveAttributes>("Mars", {150.f, 4000.f, glm::vec3(0.f, 0.f, 1.f)}));
    attr_map.insert(std::pair<std::string, PlanetRevolveAttributes>("Saturn", {300.f, 5000.f, glm::vec3(0.25f, 0.f, 0.75f)}));
    attr_map.insert(std::pair<std::string, PlanetRevolveAttributes>("Mercury", {400.f, 6000.f, glm::vec3(0.75f, 0.25f, 0.f)}));
    attr_map.insert(std::pair<std::string, PlanetRevolveAttributes>("Uranus", {600.f, 7000.f, glm::vec3(0.4f, 0.15f, 0.45f)}));
    attr_map.insert(std::pair<std::string, PlanetRevolveAttributes>("Venus", {420.f, 8000.f, glm::vec3(0.1f, 0.35f, 0.55f)}));
